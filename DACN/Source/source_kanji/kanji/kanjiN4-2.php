        ...
        <div class="tab-content">
            ...
            <div class="tab-pane active" id="Han_Tu" role="tabpanel" aria-labelledby="Han_Tu-tab">
                ...
                <div class="content_number-page">
                    <h3 style="padding-top: 20px; text-align: center;">Bộ chữ cái Hán tự N4</h3>
                    <div class="content">
                        <!-- Nav tabs -->
                        <ul class="nav nav-tabs" id="myTab" role="tablist">
                                ...
                                <?php while ($row = $check->fetch_assoc()): ?>
                                    ...
                                    <?php if($count > 60): ?>
                                        <li class="nav-item list_item" role="presentation">
                                            <button class="nav-link <?php if($count === 61){echo "active";} ?> item" id="<?php echo $item = $row['item']."-tab"; ?>" data-bs-toggle="tab" data-bs-target="<?php echo "#".$item = $row['item']; ?>" type="button" role="tab" aria-controls="<?php echo $item = $row['item']; ?>" aria-selected="<?php if($count === 61){echo "true";}else{echo "false";} ?>">
                                                <div class="itemHanTu">
                        ...
                        <div class="tab-content">
                            <?php if (!is_null($result)): ?>
                                ...
                                <?php while ($row = $result->fetch_assoc()): ?>
                                    <?php $count++; ?>
                                    <?php if($count > 60): ?>
                                    <div class="tab-pane <?php if($count === 61){echo "active";} ?>" id="<?php echo $item=$row['item']; ?>" role="tabpanel" aria-labelledby="<?php echo $item=$row['item']."-tab" ?>"> 
                    ...
                    <nav aria-label="Page navigation" style="width: 60%; display: flex; justify-content: end;">
                      <ul class="pagination" style="margin-right: 15px;">
                        <li class="page-item">
                          <a class="page-link" href="./kanjiN4.php" aria-label="Previous">
                            <span aria-hidden="true">&laquo;</span>
                          </a>
                        </li>
                        <li class="page-item "><a class="page-link" href="./kanjiN4.php">1</a></li>
                        <li class="page-item active" aria-current="page"><a class="page-link" href="./kanjiN4-2.php">2</a></li>
                        <li class="page-item disabled">
                          <a class="page-link" href="./kanjiN4-2.php" aria-label="Next">
