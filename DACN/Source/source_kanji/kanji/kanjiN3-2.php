        ...
        <div class="tab-content">
            ...
            <div class="tab-pane active" id="Han_Tu" role="tabpanel" aria-labelledby="Han_Tu-tab">
                ...
                <div class="content_number-page">
                    <h3 style="padding-top: 20px; text-align: center;">Bộ chữ cái Hán tự N3</h3>
                    <div class="content">
                        <!-- Nav tabs -->
                        <ul class="nav nav-tabs" id="myTab" role="tablist">
                    ...
                    <nav aria-label="Page navigation" style="width: 60%; display: flex; justify-content: end;">
                      <ul class="pagination" style="margin-right: 15px;">
                        <li class="page-item">
                          <a class="page-link" href="./kanjiN3.php" aria-label="Previous">
                            <span aria-hidden="true">&laquo;</span>
                          </a>
                        </li>
                        <li class="page-item "><a class="page-link" href="./kanjiN3.php">1</a></li>
                        <li class="page-item active" aria-current="page"><a class="page-link" href="./kanjiN3-2.php">2</a></li>
                        <li class="page-item disabled">
                          <a class="page-link" href="./kanjiN3-2.php" aria-label="Next">
