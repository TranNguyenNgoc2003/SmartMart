            ...
            <div class="tab-pane active" id="Tai_Lieu" role="tabpanel" aria-labelledby="Tai_Lieu-tab">
                <div class="menu_bar">
                    <ul>
                        ...
                        <li class="nav-item dropdown" >
                            <a style="color: navy;" href="./../../N5/N5.php"> N5</a>
                            <hr>
                        </li>
                        <li class="nav-item dropdown">
                ...
                <div class="content ">
                    <div class="content_left" style="width: 100%;">
                        <!-- Content -->
                        <h2 style="text-align: center; font-weight: bold; color: rgb(86, 85, 85); margin-top: 10px; margin-bottom: 30px;">Từ vựng ngữ pháp [N5] bài 1</h2>
                        <div class="Tu_vung">
