        ...
        <div class="row menu">
            <div class="col">
                ...
                <ul class="nav nav-tabs" id="myTab" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                        <button class="nav-link" id="On_Tap-tab" data-bs-toggle="tab" data-bs-target="#On_Tap" type="button" role="tab" aria-controls="On_Tap" aria-selected="false">
                            <span style="color: black;">Ôn Tập</span>
                        </button>
                    </li>
                    <li class="nav-item" role="presentation">
            ...
            <div class="tab-pane active" id="Tai_Lieu" role="tabpanel" aria-labelledby="Tai_Lieu-tab">
                ...
                <div class="content ">
                    <div class="content_left">
                        <!-- Content -->
                        <h2 style="text-align: center; font-weight: bold; color: rgb(86, 85, 85); margin-top: 10px; margin-bottom: 30px;">Từ vựng ngữ pháp [N3] bài 1</h2>
                        <div class="Tu_vung">
                    ...
                    <!-- List giao trinh -->
                    <div style="width: 22%; border-left: 2px solid rgb(228, 228, 228);">
