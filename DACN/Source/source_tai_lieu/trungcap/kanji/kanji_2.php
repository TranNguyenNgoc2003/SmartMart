...
<head>
    ...
    <link rel="stylesheet" href="./kanji_2.css">
</head>
<body>
    <div class="container-xl">
        ...
        <div class="tab-content">
            ...
            <div class="tab-pane active" id="Tai_Lieu" role="tabpanel" aria-labelledby="Tai_Lieu-tab">
                ...
                <div class="content ">
                    <div style="width: 100%;" class="content_left">
                        <!-- Content -->
                        <h2>Hán tự trung cấp</h2>
                        <div class="kanji">
                    ...
                    <!-- List giao trinh -->
                    <div div class="d-none d-md-inline-block" style="width: 28%; border-left: 2px solid rgb(228, 228, 228); margin-left: 25px;">
