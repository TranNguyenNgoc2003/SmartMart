...
<head>
    ...
    <link rel="stylesheet" href="./minna_tc-bai-1.css">
</head>
<body>
            ...
            <div class="tab-pane active" id="Tai_Lieu" role="tabpanel" aria-labelledby="Tai_Lieu-tab">
                ...
                <div class="content ">
                    <div class="content_left" style="width: 100%;">
                        <!-- Content -->
                        <h2 style="text-align: center; font-weight: bold; color: rgb(86, 85, 85); margin-top: 10px; margin-bottom: 30px;">Từ vựng ngữ pháp Minna bài 1</h2>
                        <div class="Tu_vung">
                            <h3>1. Từ vựng minna bài 1</h3>
