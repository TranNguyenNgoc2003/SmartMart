        ...
        <div class="right">
            <form action="process_edit_info.php" method="post">
                <div class="info">
                    ...
                    <div class="info_data">
                        <input type="text"
                            class="form-control" name="edit_fullname" id="edit_fullname" aria-describedby="helpId" placeholder="" value="<?php echo $user['user_name']; ?>">
                    </div>
                </div>
                <div class="info">
                    <div class="item">
                ...
                <div class="info">
                    ...
                    <div class="info_data">
                        <input type="text"
                            class="form-control" name="edit_sdt" id="edit_sdt" aria-describedby="helpId" placeholder="" value="<?php echo $user['user_phone']; ?>">
                    </div>
                </div>
                <div class="info">
                    <div class="item">
                    ...
                    <div class="info_data">
                        <input type="password"
                            class="form-control" name="edit_pass" id="edit_pass" aria-describedby="helpId" placeholder="" value="<?php echo $user['user_password']; ?>">
                    </div>
                </div>
