    ...
    <?php
        ...
        if($_SERVER["REQUEST_METHOD"]=="POST"){
            ...
            if (empty($user_name) || empty($user_phone) || empty($user_email) || empty($_POST["txtPassword"])) {
                ...
                $sql = "INSERT INTO userdata (user_name, user_phone, user_email, user_password)
    ...
    <div class="sign_up">
        ...
        <div class="form_login ">
            ...
            <label for="" class="form-label">Name user</label>
                ...
                <button style="width: 100%; background-color: navy; border-radius: 20px;" type="submit" class="btn btn-primary">Sign Up</button>
