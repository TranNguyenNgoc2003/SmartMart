...
<body>
    <?php
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            $sql = "SELECT admin_email,admin_password
                    FROM admindata WHERE admin_email='$admin_email' AND admin_password='$admin_password'";
    ...
    <div class="login">
        <div class="welcome" style="width: 350px; margin-top: 60px;">
            ...
            <span style="display: flex; justify-content: center;">
                <img src="./../image_bground/japan.png" style="width: 80%;" alt="">
            </span>
        </div>
