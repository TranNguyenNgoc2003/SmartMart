<?php
    ...
    $sql_sel_kh = "SELECT * FROM userdata";
    $result_us = $conn->query($sql_sel_kh);
...
<body>
    <div class="container-fluid">
        ...
        <div class="content_menu" style="display: flex; ">
            ...
            <!-- content -->
            <div class="container content" style="display: flex; justify-content: space-between;">
                <div class="left">
                    <h2>Tìm Kiếm Thông Tin Khách Hàng</h2>
                    <form action="hienthitt_kh.php" method="GET">
                        <div class="mb-3" style="width: 400px;">
                            <label for="" class="form-label">Nhập số điện thoại khách hàng:</label>
                            <input
                                type="text"
                                class="form-control"
                                style="width: 300px;"
                ...
                <div class="right" style=" width: 50%; margin-top: 50px;">
                    <div class="form_us" style="background-color:rgb(199, 199, 199);">
                        <div class="STT">
                            STT
                        </div>
                        <div class="name_us">
                    ...
                    <?php if ($result_us->num_rows > 0): $STT = 0;?>
                        <?php while(($row_us = $result_us->fetch_assoc()) && ($STT < 10)): $STT++; ?>
                            <div class="form_us">
                                <div class="STT">
                                    <?php echo $STT; ?>
                                </div>
                                <div class="name_us">
                                    <?php echo $row_us['user_name']; ?>
                                </div>
                                <div class="phone_us">
                                    <?php echo $row_us['user_phone']; ?>
                                </div>
                            </div>
                        <?php endwhile; ?>
                    <?php endif;?>
