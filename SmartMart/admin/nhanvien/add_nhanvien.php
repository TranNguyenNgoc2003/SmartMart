    ...
    <div class="container-fluid">
        ...
        <div class="content_menu" style="display: flex; ">
            ...
            <div class="container content" >
                ...
                <form action="process_add_nhanvien.php" method="POST">
                    ...
                    <input type="text" id="GioiTinh" name="GioiTinh"><br><br>
                    ...
                    <input type="date" id="NgayBatDauLamViec" name="NgayBatDauLamViec"><br><br>
